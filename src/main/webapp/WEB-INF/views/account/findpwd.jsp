...
<div class="container-contact100">
	<div class="wrap-contact100">
		...
		<form class="contact100-form validate-form" action="login" onsubmit="return checkpwd()" data-ajax="false" method="post">
			<span class="contact100-form-title">비밀번호 찾기</span>
			...
			<div class="wrap-input100 validate-input" data-validate = "이메일은 필수항목입니다.">
				<input class="input100" type="password" name="passwd" placeholder="이메일">
				<span class="focus-input100"></span>
				<span class="symbol-input100">
					<i class="fa fa-user" aria-hidden="true"></i>
				</span>
			...
			<div class="container">
				<a href="/spacerental/account/findId" class="col-md-2">아이디 찾기</a> 
				<a href="/spacerental/account/findPwd" class="col-md-2">비밀번호 찾기</a> 
			</div>
		</form>
	</div>		
</div>
